...
import { MovingBorder } from '../ui/border-beam';
      ...
      <Container>
        <div className="flex flex-col items-center justify-center py-20 h-full">
          ...
          <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
            <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50">
          ...
          <div className="relative flex items-center py-10 md:py-20 w-full">
            <MovingBorder size={250} duration={12} delay={9} />
