  ...
  return (
    <div className="w-[100%] py-8">
      <div className="flex items-center justify-between pb-8">
        <Button onClick={() => setPreview(false)} variant="outline" className="flex items-center gap-2">
          <ArrowLeft size={14} /> Back
        </Button>
        <Button onClick={editSpace} disabled={loading} className="flex items-center gap-2">
          {loading ? (
            <>
            ...
            <>
              <Rocket size={20} /> Edit Space
            </>
          )}
        </Button>
      </div>

      <div className="dark:bg-neutral-800 dark:text-white bg-neutral-100 text-black p-12 rounded-lg shadow-lg overflow-hidden relative">
        <div className="bg-[#EA580C] text-white absolute top-0 left-0 px-4 py-1 text-center flex items-center gap-2 rounded-br-lg">
          <Eye size={18} />
          <p>Live preview</p>
        </div>
