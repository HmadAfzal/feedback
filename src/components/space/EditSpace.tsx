    ...
    {preview ? (
        ...
        <div className='w-[100%]  py-12 '>
            ...
            <div className='flex flex-col gap-4'>
                <h1 className='text-center font-bold text-4xl text-[#EA580C]'>Edit your space</h1>
                <p className='text-center tracking-wide px-10'>
                    After editing the Space, we will generate a preview page for you.
                </p>
            </div>
            <div className='py-8'>
                <Form {...form}>
                                        ...
                                        <FormControl>
                                            <div className='flex items-center gap-3'>
                                                <Avatar className='h-10 w-10'>
                                                    <AvatarImage src={imageFile? imageFile:space?.image} />
