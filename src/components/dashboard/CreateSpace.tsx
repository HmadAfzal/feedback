              ...
              <div className="w-full py-12 px-4 md:px-8 lg:px-12">
                <div className="flex flex-col gap-4 md:w-full w-[80%]">
                  ...
                  <p className="md:text-center tracking-wide md:px-8 lg:px-10 text-muted-foreground md:text-md text-sm">
                    After the Space is created, it will generate a dedicated page for collecting feedback.
                  </p>
                </div>
                <div className="py-8">
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
                                ...
                                <FormControl>
                                  <div className="flex items-center gap-3">
                                    <Avatar className="h-10 w-10">
                                      <AvatarImage
                                        src={imageFile ? imageFile : user?.profilepic}
                                      />
                      ...
                      <div className="flex items-center justify-between">
                        <Button variant={"outline"} onClick={() => setCreateSpace(false)}>
                          Cancel
                        </Button>
