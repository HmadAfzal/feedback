    ...
    <div
      className={`${
        spaceData?.theme == "dark"
          ...
          : "bg-white text-black"
      }  px-6 min-h-screen flex items-center justify-center`}
    >
      <div className="w-full max-w-[90%] md:max-w-[80%]">
        <div className="flex flex-col items-center justify-center md:gap-4 gap-2 pb-2">
          <Avatar className="h-24 w-24 md:h-36 md:w-36">
            <AvatarImage src={spaceData?.image} />
            <AvatarFallback>img</AvatarFallback>
          </Avatar>

          <h1 className="text-center font-bold text-2xl md:text-4xl  text-[#EA580C]">
            {spaceData?.title}
          </h1>
          <p className="text-center tracking-wide px-2 md:px-10 text-md md:text-lg">
        ...
        <div className="pt-8 md:pt-12 flex flex-col gap-4 md:gap-6 pb-8 md:pb-12">
          ...
          <ul className="list-disc flex flex-col gap-2 text-sm">
            ...
            <li>
              Base your feedback on observable behavior or specific outcomes
              rather than personal opinions or feelings.
            </li>
            <li>
              Consider the recipient&apos;s feelings and be respectful in your
              tone.
            </li>
            <li>
        ...
        >
          <DialogTrigger asChild>
            <Button className="w-full flex items-center gap-3">
              <PenSquareIcon className="md:size-5 size-4" /> {spaceData?.buttonText}
            </Button>
          </DialogTrigger>
          <DialogContent
          ...
          >
            <DialogHeader>
              <div className="flex flex-col items-center justify-center gap-2 ">
                ...
                <DialogTitle className="text-center font-bold text-xl text-[#EA580C]">
                  {spaceData?.name}
                </DialogTitle>
              </div>
              <DialogDescription className="text-center">
                Send feedback to {spaceData?.name}. This action cannot be
                undone.
              </DialogDescription>
            </DialogHeader>
              ...
              <Form {...form}>
                ...
                >
                      ...
                      <FormItem className="pb-2">
                        ...
                        <FormControl>
                          <Input
                            placeholder="Name"
                            {...field}
                            className="bg-transparent border-neutral-700 focus:border-none"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                  ...
                  <div className="flex items-center space-x-2 pb-4">
                    ...
                    >
                      I give permission to use this feedback.
                    </label>
                  </div>
        ...
        <Dialog
          ...
          onOpenChange={(open) => setShowThankYouDialog(open)}
        >
          <DialogContent
            className={`sm:max-w-[425px] border-none ${
              spaceData?.theme == "dark"
          ...
          >
            <DialogHeader>
              <div className="flex w-full items-center justify-center">
                <Image
                  src="https://media.giphy.com/media/8qD1FHjc4wllVBL3ln/giphy.gif?cid=ecf05e47gvya2nlu06oll65e05mxeg23paqfdhwynqmzbbyf&ep=v1_gifs_search&rid=giphy.gif&ct=g"
                  alt="img"
                  height={300}
                  width={300}
