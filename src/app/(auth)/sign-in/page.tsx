...
const page = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center gap-4 h-screen'>
      ...
      <Button className='w-full flex items-center justify-center gap-2' onClick={handleGithubSignin}><FaGithub size={20} />Continue with GitHub</Button>
      <Button className='w-full flex items-center justify-center gap-2' onClick={handleGoogleSignin}><FaGoogle size={18} />Continue with Google</Button>
